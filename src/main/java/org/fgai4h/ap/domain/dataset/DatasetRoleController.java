...
public class DatasetRoleController {
    ...
    public DatasetRoleController(DatasetRoleRepository datasetRoleRepository, DatasetRoleModelAssembler datasetRoleModelAssembler) {
        this.datasetRoleRepository = datasetRoleRepository;
        this.datasetRoleModelAssembler = datasetRoleModelAssembler;
    }
