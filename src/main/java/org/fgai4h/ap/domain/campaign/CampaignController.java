...
public class CampaignController {
    ...
    @Autowired
    private CampaignModelAssembler campaignModelAssembler;

    @GetMapping("/campaigns")
    public ResponseEntity<CollectionModel<CampaignModel>> getAllCampaigns()
    {
        List<CampaignEntity> actorEntities = campaignRepository.findAll();
        return new ResponseEntity<>(
                campaignModelAssembler.toCollectionModel(actorEntities),
                HttpStatus.OK);
    }
